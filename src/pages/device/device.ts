...
export class DevicePage {
  ...
  connect(deviceID) {
    ...
    BLE.connect(deviceID).subscribe(peripheralData => {
      ...
      subscription.subscribe(data => {
           ...
           // console.log("this is json.stringify: " + (JSON.stringify(data)));
           // var new_int = this.bytesToString(data);
            // console.log("this is the type of data: " + (typeof new_int));

            // if (new_int[0] == 1) {
            //   // this.heroes.push("img/HeroWarrior2.png")
            //   this.heroes = "img/WarriorV2.png"
            // // } else {
            // //   // this.heroes.push("img/HeroGatherer2.png")
            // //   this.heroes = "img/HeroWarrior2.png"
            // } else if (new_int[0] == -1) {
            //   this.heroes = "img/MysticV2.png"
            // } else {
            //   this.heroes = "img/MysticV2.png"
            // }
       });
  ...
  getlatlong(string) {
    ...
    // console.log("from button with (): " + ((this.a).length - 1));
    console.log("from button: " + (this.a.length - 1));
    console.log("value from array: " + this.a[this.a.length - 1]);
    console.log("2nd value from end array: " + this.a[this.a.length - 2]);
    console.log("3rd value from end array: " + this.a[this.a.length - 3]);
    console.log("print all of a: " + this.a);
    // console.log("from button: " + this.a);
    ...
    if (this.a[this.a.length - 3] == "m") {
      // this.heroes.push("img/HeroWarrior2.png")
      this.heroes = "img/MysticV2.png"
    } else if (this.a[this.a.length - 3] == "w") {
      // this.heroes.push("img/HeroGatherer2.png")
      this.heroes = "img/WarriorV2.png"
    }
  }
  ...
  bytesToInteger(buffer) {
      // var new_int = new Int16Array(buffer);
